...
export class BookDetailsContainer extends Component<BookDetailsContainerProps, BookDetailsContainerState> {
  ...
  componentDidUpdate(prevProps: Readonly<BookDetailsContainerProps>, prevState: Readonly<BookDetailsContainerState>, snapshot?: any): void {
  ...
  onBookChange = (book: Book): Promise<any> => {
    return this.props.bookService.save(book).then(
